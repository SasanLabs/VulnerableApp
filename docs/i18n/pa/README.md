...
![ਪੂਰਾ ਆਰਕੀਟੈਕਚਰ ਸਟੈਕ](https://github.com/SasanLabs/VulnerableApp/blob/master/docs/logos/sasanlabs.png)
...
2. VulnerableApp ਨੂੰ ਇੱਕ ਸਟੈਂਡਅਲੋਨ Vulnerable Application ਵਜੋਂ ਚਲਾਉਣ ਦਾ ਦੂਜਾ ਤਰੀਕਾ:
    1. Github ਦੇ [Releases Section](https://github.com/SasanLabs/VulnerableApp/releases) ਵਿੱਚ ਜਾਓ ਅਤੇ ਸਭ ਤੋਂ ਨਵੇਂ ਰਿਲੀਜ਼ ਕੀਤੇ ਵਰਜਨ ਲਈ Jar ਡਾਊਨਲੋਡ ਕਰੋ
...
1. Docker ਐਪਲੀਕੇਸ਼ਨ ਵਜੋਂ, ਜੋ ਪੂਰੀ VulnerableApplication ਚਲਾਉਣ ਵਿੱਚ ਮਦਦ ਕਰੇਗੀ। Docker ਐਪਲੀਕੇਸ਼ਨ ਵਜੋਂ ਚਲਾਉਣ ਲਈ:
    ...
    2. [Docker-Compose](https://github.com/SasanLabs/VulnerableApp-facade/blob/main/docker-compose.yml) ਡਾਊਨਲੋਡ ਕਰੋ ਅਤੇ ਉਸੇ ਡਾਇਰੈਕਟਰੀ ਵਿੱਚ `docker-compose up` ਚਲਾਓ
...
1. ਜੇ ਤੁਸੀਂ ਇੱਕ ਡਿਵੈਲਪਰ ਹੋ ਅਤੇ ਪ੍ਰੋਜੈਕਟ ਸ਼ੁਰੂ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ, ਤਾਂ [issues](https://github.com/SasanLabs/VulnerableApp/issues) ਦੀ ਸੂਚੀ ਵੇਖੋ, ਜਿਸ ਵਿੱਚ `good first issue` ਵਾਲੇ ਮੁੱਦੇ ਸ਼ੁਰੂਆਤ ਲਈ ਚੰਗੇ ਹਨ।
...
3. **UI ਤੱਕ ਪਹੁੰਚ**: ਆਪਣੇ ਬਦਲਾਵਾਂ ਨਾਲ ਆਧੁਨਿਕ UI ਵੇਖਣ ਲਈ `http://localhost` 'ਤੇ ਜਾਓ।

4. **Mailpit ਤੱਕ ਪਹੁੰਚ**: ਲੋਕਲ SMTP ਸਰਵਰ ਦੁਆਰਾ ਕੈਪਚਰ ਕੀਤੀਆਂ ਈਮੇਲਾਂ ਵੇਖਣ ਲਈ `http://localhost:8025` 'ਤੇ ਜਾਓ।
...
1. [ਦਸਤਾਵੇਜ਼](https://sasanlabs.github.io/VulnerableApp)
2. [ਡਿਜ਼ਾਈਨ ਦਸਤਾਵੇਜ਼](https://sasanlabs.github.io/VulnerableApp/DesignDocumentation.html)
3. [Owasp VulnerableApp](https://owasp.org/www-project-vulnerableapp/)
4. [OWASP Spotlight ਸੀਰੀਜ਼ ਲਈ ਝਲਕ ਵੀਡੀਓ](https://www.youtube.com/watch?v=HRRTrnRgMjs)
5. [ਝਲਕ ਵੀਡੀਓ](https://www.youtube.com/watch?v=AjL4B-WwrrA&ab_channel=OwaspVulnerableApp)

### ਬਲੌਗ

1. [Owasp-VulnerableApp ਦੀ ਝਲਕ - Medium ਲੇਖ](https://hussaina-begum.medium.com/an-extensible-vulnerable-application-for-testing-the-vulnerability-scanning-tools-cc98f0d94dbc)
2. [Owasp-VulnerableApp ਦੀ ਝਲਕ - Blogspot ਪੋਸਟ](https://hussaina-begum.blogspot.com/2020/10/an-extensible-vulnerable-application.html)
3. [Kenji Nakajima ਦੁਆਰਾ Owasp VulnerableApp ਦਾ ਪਰਿਚਯ](https://jpn.nec.com/cybersecurity/blog/220520/index.html)
4. [Gen AI ਆਧਾਰਿਤ ਪਲੇਟਫਾਰਮ Shannon ਦੁਆਰਾ VulnerableApp ਦਾ ਸ਼ੋਸ਼ਣ](https://qiita.com/fiord/items/9351bcff6d646862f181)
5. [ਮੈਂ OWASP ZAP File Upload Addon ਬਣਾਇਆ। ਇਹ ਹੈ ਕਿ ਪਹਿਲਾਂ VulnerableApp-Facade ਦਾ ਹੋਣਾ ਕਿਉਂ ਜ਼ਰੂਰੀ ਸੀ](https://medium.com/p/52c4f2226ed3)

### OWASP VulnerableApp ਦੀ ਵਰਤੋਂ

1. [ਵਿਸ਼ਵ ਪੱਧਰੀ ਅਕਾਦਮਿਕ ਦਿਲਚਸਪੀ ਵੇਖੋ](../../Usage.md)

### ਸਮੱਸਿਆ ਨਿਵਾਰਣ ਹਵਾਲੇ

1. [SQL Injection Vulnerability ਦਾ ਸ਼ੋਸ਼ਣ ਕਰਨ ਬਾਰੇ Reddit](https://www.reddit.com/r/hacking/comments/11wtf17/owasp_vulnerableappfacade_sql_injection/)
...
4. [ਪੰਜਾਬੀ](https://github.com/SasanLabs/VulnerableApp/tree/master/docs/i18n/pa/README.md)
5. [ਕੋਰੀਆਈ](https://github.com/SasanLabs/VulnerableApp/tree/master/docs/i18n/ko/README.md)
