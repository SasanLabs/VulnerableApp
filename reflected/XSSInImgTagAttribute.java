...
public class XSSInImgTagAttribute {
    ...
    public ResponseEntity<String> getVulnerablePayloadLevelSecure(
        ...
        // Escape all href link provided in a payload
    // and validate input.
    @AttackVector(
            vulnerabilityExposed = VulnerabilityType.REFLECTED_XSS,
            description = "HTML_ESCAPE_PLUS_FILTERING_HREF_LINK_ON_INPUT_SRC_ATTRIBUTE_IMG_TAG")
    ...
    // Checking for onload function passing into the html tag
    // and validate input.'
    @AttackVector(
            vulnerabilityExposed = VulnerabilityType.REFLECTED_XSS,
            description =
