...
class EmailServiceImplTest {
    ...
    @Test
    void shouldAllowMissingConfigurationWithoutThrowing() {
        EmailConfiguration emailConfiguration = new EmailConfiguration();

        assertDoesNotThrow(() -> new EmailServiceImpl(javaMailSender, emailConfiguration));
    }

    @Test
    void shouldNotFailWhenMailServerIsUnavailable() {
        ...
        assertDoesNotThrow(() -> emailService.sendEmail("student@example.com", "Subject", "Body"));
    }
