        ...
        if (totalFiles > 0) {
            ...
            for (let i = 0; i < totalFiles; ++i) {
                ...
                if (file.size > 10485760 || totalLength > 10485760) {
                    ...
                    document.getElementById("uploaded_files_info").innerHTML = "Max upload size exceeded exception : " +
                        "the request was rejected because its size (" + size + ") exceeds the configured maximum (10485760)";
                    return;
                } else {
