...
function getImageData(data){
    ...
    while(imageResponseDiv.firstChild && imageResponseDiv.removeChild(imageResponseDiv.firstChild));
    if (!data.content) {
        document.getElementById("imageResponse").append("That URL couldn't be processed.");
    } else {
