 ...
 */
// @comment -- "Top-level REST endpoints that enumerate and describe vulnerable endpoints for UI and scanners."
// @flows #browser -> #web-controllers via HTTP -- "Enumerates endpoints and returns JSON/XML to clients"
@RestController
