...
public enum ExceptionStatusCodeEnum {
	...
	INVALID_END_POINT("INVALID_END_POINT"), INVALID_LEVEL("INVALID_LEVEL"), UNAVAILABLE_LEVEL("UNAVAILABLE_LEVEL"),
	INVALID_ACCESS("INVALID_ACCESS"), INVALID_ARGUMENTS("INVALID_AGRUMENTS"), SYSTEM_ERROR("SYSTEM_ERROR");
