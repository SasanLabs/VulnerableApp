...
public class ServiceApplicationException extends Exception {
	...
	public ServiceApplicationException(ExceptionStatusCodeEnum exceptionStatusCodeEnum, Object... args) {
		this.exceptionStatusCode = exceptionStatusCodeEnum;
		this.setArgs(args);
	}

	public ServiceApplicationException(String message, ExceptionStatusCodeEnum exceptionStatusCodeEnum,
			Object... args) {
		super(message);
		this.exceptionStatusCode = exceptionStatusCodeEnum;
		this.setArgs(args);
	...
	public ServiceApplicationException(String message, Throwable throwable,
