...
/**
 * This class contains all the properties related to vulnerableApp. This bean is
 * registered through {@link VulnerableAppConfiguration}.
 * In case in future we want to add new properties to vulnerableApp please use this bean.
 * 
