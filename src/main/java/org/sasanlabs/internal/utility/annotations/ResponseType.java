...
/**
 * Usage of this is to distinguish what is the response type from the {@link ICustomVulnerableEndPoint}.
 ...
 * be consumed by any application without the use of frontend like say a CTF hosting 
 * platform may or may not use the UserInterface provided by vulnerableApp.
 * 
